    ...
    <div className="min-h-screen bg-gradient-to-br from-[#5B21B6]/5 to-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-8 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-3 ml-4">
                  ...
                  <li><span className="font-semibold">Third-party Social Media Service</span> refers to any website or any social network website through which a User can log in or create an account to use the Service.</li>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Collecting and Using Your Personal Data</h2>
            <div className="space-y-6">
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-[#2563EB]">Types of Data Collected</h3>
                
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-[#38BDF8]">Personal Data</h4>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-[#38BDF8]">Usage Data</h4>
                  <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Information from Third-Party Social Media Services</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Tracking Technologies and Cookies</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h3 className="text-xl font-semibold text-[#2563EB]">We use both Session and Persistent Cookies for the purposes set out below:</h3>
            
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-[#5B21B6]/10 to-[#2563EB]/10 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-[#5B21B6] mb-2">Necessary / Essential Cookies</h4>
              ...
              <div className="bg-gradient-to-r from-[#5B21B6]/10 to-[#2563EB]/10 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-[#5B21B6] mb-2">Cookies Policy / Notice Acceptance Cookies</h4>
              ...
              <div className="bg-gradient-to-r from-[#5B21B6]/10 to-[#2563EB]/10 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-[#5B21B6] mb-2">Functionality Cookies</h4>
                <p className="text-gray-700 mb-2">Type: Persistent Cookies</p>
                <p className="text-gray-700 mb-2">Administered by: Us</p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Use of Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Sharing of Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Retention of Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Transfer of Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Delete Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Disclosure of Your Personal Data</h2>
            
            <div className="space-y-6">
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-[#2563EB]">Business Transactions</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-[#2563EB]">Law enforcement</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-[#2563EB]">Other legal requirements</h3>
                <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Security of Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Children&apos;s Privacy</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[#5B21B6]">Changes to this Privacy Policy</h2>
            <p className="text-gray-600 leading-relaxed">
